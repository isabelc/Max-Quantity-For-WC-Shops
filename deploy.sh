...
# main config
PLUGINSLUG="woocommerce-max-quantity" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="woocommerce-max-quantity.php" # this should be the name of your main php file in the wordpress plugin
